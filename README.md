...
Deploy FastAPI Machine Learning model dengan menggunakan Cloud Run
...
$ activate
$ cd ..
$ git clone https://github.com/sendhyrama/fastapi-deployment-cloudrun
...
4. Buka terminal atau command prompt, lalu arahkan ke direktori tempat Anda ingin clone repository FastAPI.

5. Clone repository FastAPI dengan menjalankan perintah berikut:
   ` git clone https://github.com/sendhyrama/fastapi-deployment-cloudrun `
 
 6. Setelah proses clone selesai, arahkan terminal atau command prompt ke direktori FastAPI yang baru saja di cloning.
